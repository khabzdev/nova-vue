...
Nova Vue uses CSS custom properties (design tokens) for theming. This allows you to easily customize colors, spacing, and other visual properties to match your brand.
...
### Method 2: Using @nova-vue/colors Presets
...
// main.ts
import '@nova-vue/ui/styles.css'
import '@nova-vue/colors/blue.css'  // or red, green, orange, violet, etc.
```

Available color themes:
- `@nova-vue/colors/blue.css` - Professional blue
- `@nova-vue/colors/red.css` - Bold red
- `@nova-vue/colors/rose.css` - Soft rose/pink
- `@nova-vue/colors/orange.css` - Energetic orange
- `@nova-vue/colors/yellow.css` - Bright yellow
- `@nova-vue/colors/green.css` - Fresh green
- `@nova-vue/colors/violet.css` - Creative violet
...
Nova Vue uses the `.dark` class for dark mode. Override dark mode tokens in the `.dark` selector:
