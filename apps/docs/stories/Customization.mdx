...
### Method 2: Using @novavue/colors Presets
...
// main.ts
import '@novavue/ui/styles.css'
import '@novavue/colors/blue.css'  // or red, green, orange, violet, etc.
```

Available color themes:
- `@novavue/colors/blue.css` - Professional blue
- `@novavue/colors/red.css` - Bold red
- `@novavue/colors/rose.css` - Soft rose/pink
- `@novavue/colors/orange.css` - Energetic orange
- `@novavue/colors/yellow.css` - Bright yellow
- `@novavue/colors/green.css` - Fresh green
- `@novavue/colors/violet.css` - Creative violet
